  ...
  switch (status) {
    case 'pending':
      return {
        ...
        text: i18n.t('statusUtils.projectPending'),
    ...
    case 'processing':
      return {
        ...
        text: i18n.t('statusUtils.projectProcessing'),
        badgeStatus: 'processing',
    ...
    case 'completed':
      return {
        ...
        text: i18n.t('statusUtils.projectCompleted'),
        badgeStatus: 'success',
    ...
    case 'failed':
      return {
        ...
        text: i18n.t('statusUtils.projectFailed'),
        badgeStatus: 'error',
    ...
    default:
      return {
        color: '#d9d9d9',
        icon: ClockCircleOutlined,
        text: i18n.t('statusUtils.projectUnknown'),
        badgeStatus: 'default',
        backgroundColor: 'rgba(217, 217, 217, 0.15)',
        borderColor: 'rgba(217, 217, 217, 0.3)'
      }
  ...
  switch (status) {
    case 'pending':
      return {
        color: '#1890ff',
        icon: ClockCircleOutlined,
        text: i18n.t('statusUtils.taskPending'),
        badgeStatus: 'processing'
      }
    case 'running':
      return {
        ...
        text: i18n.t('statusUtils.taskRunning'),
        badgeStatus: 'processing'
      }
    case 'completed':
      return {
        color: '#52c41a',
        icon: CheckCircleOutlined,
        text: i18n.t('statusUtils.taskCompleted'),
        badgeStatus: 'success'
      }
    case 'failed':
      return {
        ...
        text: i18n.t('statusUtils.taskFailed'),
        badgeStatus: 'error'
      }
    case 'cancelled':
      return {
        color: '#d9d9d9',
        icon: CloseCircleOutlined,
        text: i18n.t('statusUtils.taskCancelled'),
        badgeStatus: 'default'
      }
    default:
      return {
  ...
  switch (status) {
    case 'pending':
      return {
        color: '#1890ff',
        icon: ClockCircleOutlined,
        text: i18n.t('statusUtils.uploadPending'),
        badgeStatus: 'processing'
      }
    case 'processing':
      return {
        color: '#1890ff',
        icon: LoadingOutlined,
        text: i18n.t('statusUtils.uploadProcessing'),
        badgeStatus: 'processing'
      }
    case 'success':
      return {
        color: '#52c41a',
        icon: CheckCircleOutlined,
        text: i18n.t('statusUtils.uploadSuccess'),
        badgeStatus: 'success'
      }
    case 'failed':
      return {
        color: '#ff4d4f',
        icon: CloseCircleOutlined,
        text: i18n.t('statusUtils.uploadFailed'),
        badgeStatus: 'error'
      }
    default:
      return {
