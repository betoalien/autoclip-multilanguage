...
const AddClipToCollectionModal: React.FC<AddClipToCollectionModalProps> = ({
  ...
  return (
    <Modal
      title={t('collection.addClipToCollectionTitle')}
      open={visible}
      ...
      footer={[
        ...
        >
          {t('collection.addClip')} {selectedClipIds.length > 0 && `(${selectedClipIds.length})`}
        </Button>
      ]}
    >
      <div className="add-clip-modal-content">
        ...
        <div className="search-section">
          ...
          <div className="action-bar">
            <Space>
              <Text type="secondary">
                {t('collection.availableCount', { count: filteredClips.length })}
              </Text>
              {filteredClips.length > 0 && (
                ...
                >
                  {selectedClipIds.length === filteredClips.length ? t('collection.deselectAll') : t('collection.selectAll')}
                </Button>
              )}
            </Space>
          </div>
                      ...
                      <div className="clip-info">
                        ...
                        <div className="clip-meta">
                          <Space size="small">
                            ...
                            >
                              {t('collection.scoreColon', { score: (clip.final_score * 100).toFixed(0) })}
                            </Tag>
                          </Space>
                        </div>
              ...
              <Empty
                ...
                description={
                  availableClips.length === 0
                    ? t('collection.allClipsInCollection')
                    : t('collection.noMatchingClips')
                }
              />
            </div>
          )}
