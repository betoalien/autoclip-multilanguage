    ...
    return (
      <Card size="small" style={{ margin: '8px 0' }}>
        <Space direction="vertical" style={{ width: '100%' }}>
          <Text type="secondary">{t('taskProgress.waitingToStart')}</Text>
          <Progress 
            percent={0} 
            status="active" 
            strokeColor="#1890ff"
      ...
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        {showDetails && message && (
          <Text type="secondary" style={{ fontSize: '12px' }}>
            {getLocalizedProgressMessage(message)}
          </Text>
        )}
        ...
        {showDetails && ts > 0 && (
          <Text type="secondary" style={{ fontSize: '11px' }}>
            {t('taskProgress.updateTimeLabel')}{new Date(ts * 1000).toLocaleTimeString()}
          </Text>
        )}
      </Space>
    </Card>
