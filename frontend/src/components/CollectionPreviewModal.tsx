  ...
  return (
    ...
    >
        ...
        <div className="preview-header">
          ...
          <div className="header-right">
            <Space>
              ...
              >
                {t('collection.exportFullVideo')}
              </Button>
              <Button
                type="default"
                icon={<UploadOutlined />}
                onClick={() => message.info(t('collection.uploadWip'), 3)}
              >
                {t('collection.uploadToBilibili')}
              </Button>
              {onDelete && (
                <Popconfirm
              ...
              <Button
                ...
                icon={<CloseOutlined />}
                onClick={onClose}
                aria-label={t('collection.closePreviewAria')}
                    ...
                    <div className="video-info-content">
                      <div className="video-title-section">
                        <div className="video-title">
                          <EditableTitle
                            title={currentClip.title || currentClip.generated_title || t('clip.untitled')}
                        ...
                        <div className="video-meta">
                          ...
                          >
                            <span className="ac-mono">{(currentClip.final_score * 100).toFixed(0)}</span> {t('collection.scoreUnit')}
                          </Tag>
                                  ...
                                  <div className="clip-meta">
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px' }}>
                                      ...
                                      <span className="ac-mono" style={{
                                        ...
                                        {t('collection.scoreValue', { score: (clip.final_score * 100).toFixed(0) })}
                                      </span>
                                    </div>
                                  </div>
      ...
      <UploadModal
        ...
        clipTitles={collectionClips.map(clip => clip.generated_title || clip.title || t('collection.videoClip'))}
        onSuccess={() => {
          // 投稿成功后可以刷新数据或显示提示
          console.log('合集投稿成功')
        }}
