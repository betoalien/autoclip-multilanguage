          ...
          <Row gutter={24}>
            ...
            <Col span={14}>
              ...
              <div style={{ marginBottom: '16px' }}>
                <Space size="middle">
                  ...
                  {clip.final_score && (
                    ...
                    >
                      {t('clip.scoreLabel', { score: (clip.final_score * 100).toFixed(0) })}
                    </Tag>
                  )}
                  {clip.outline && (
              ...
              <Space>
                ...
                >
                  {playing ? t('clip.pause') : t('clip.play')}
                </Button>
                <Button
                  type="default"
              ...
              <div style={{ color: '#ffffff' }}>
                ...
                <div style={{ marginBottom: '16px' }}>
                  <div style={{ marginBottom: '8px' }}>
                    <EditableTitle
                      title={clip.generated_title || clip.title || t('clip.untitled')}
                      clipId={clip.id}
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <div style={{ color: '#cccccc', fontSize: '14px' }}>
                    <div>{t('clip.startTime')}: {formatTime(clip.start_time)}</div>
                    <div>{t('clip.endTime')}: {formatTime(clip.end_time)}</div>
                  </div>
                </div>
