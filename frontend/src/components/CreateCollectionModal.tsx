      ...
      <div className="modal-content">
        ...
        <div className="modal-header">
          ...
          <div className="header-text">
            <Title level={3} className="modal-title">{t('collection.createTitle')}</Title>
            <Text className="modal-subtitle">{t('collection.createSubtitle')}</Text>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="form-item">
            <div className="form-label">
              ...
              <Text strong>{t('collection.titleLabel')}</Text>
          ...
          <div className="form-item">
            <div className="form-label">
              ...
              <Text strong>{t('collection.summaryLabel')}</Text>
            </div>
            <TextArea
          ...
          <div className="form-item">
            <div className="form-label">
              ...
              <Text strong>{t('collection.selectClips')}</Text>
              <span className="required-mark">*</span>
            </div>
            ...
            <div className="clips-selection">
              <div className="selection-header">
                <Text className="selection-info">
                  {t('collection.selectedCount', { count: selectedClips.length })}
                </Text>
                  ...
                  >
                    ...
                    <div className="clip-content">
                      <div className="clip-title">
                        {clip.generated_title || clip.title || t('clip.untitled')}
                      </div>
                      <div className="clip-meta">
                        <Text type="secondary" style={{ fontSize: '12px' }}>
                          {clip.start_time} - {clip.end_time} • {t('clip.scoreColon', { score: (clip.final_score * 100).toFixed(0) })}
                        </Text>
                      </div>
                    </div>
                  </div>
