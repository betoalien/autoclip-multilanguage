...
def create_app(mode: str = "web") -> FastAPI:
    ...
    async def get_video_categories(request: Request):
        ...
        if is_zh:
            categories = [
                ...
                {"value": "knowledge", "name": "知识科普", "description": "科学、技术、历史、文化等知识类内容", "icon": "📚", "color": "#52c41a"},
                {"value": "entertainment", "name": "娱乐", "description": "游戏、音乐、电影等娱乐内容", "icon": "🎮", "color": "#722ed1"},
                {"value": "business", "name": "商业", "description": "商业、创业、投资等商业内容", "icon": "💼", "color": "#faad14"},
                {"value": "experience", "name": "经验分享", "description": "个人经历、生活感悟等经验内容", "icon": "🌟", "color": "#13c2c2"},
                {"value": "opinion", "name": "观点评论", "description": "时事评论、观点分析等评论内容", "icon": "💭", "color": "#722ed1"},
                {"value": "speech", "name": "演讲", "description": "公开演讲、讲座等演讲内容", "icon": "🎤", "color": "#eb2f96"},
            ...
            categories = [
                ...
                {"value": "knowledge", "name": "Education", "description": "Science, technology, history, and education", "icon": "📚", "color": "#52c41a"},
                {"value": "entertainment", "name": "Entertainment", "description": "Gaming, music, movies, and entertainment", "icon": "🎮", "color": "#722ed1"},
                {"value": "business", "name": "Business", "description": "Business, entrepreneurship, and finance", "icon": "💼", "color": "#faad14"},
                {"value": "experience", "name": "Experience", "description": "Personal experiences and lifestyle insights", "icon": "🌟", "color": "#13c2c2"},
            ...
            categories = [
                ...
                {"value": "knowledge", "name": "Educación", "description": "Ciencia, tecnología, historia y cultura", "icon": "📚", "color": "#52c41a"},
                {"value": "entertainment", "name": "Entretenimiento", "description": "Juegos, música, cine y entretenimiento", "icon": "🎮", "color": "#722ed1"},
                {"value": "business", "name": "Negocios", "description": "Negocios, emprendimiento y finanzas", "icon": "💼", "color": "#faad14"},
                {"value": "experience", "name": "Experiencia", "description": "Experiencias personales y estilo de vida", "icon": "🌟", "color": "#13c2c2"},
